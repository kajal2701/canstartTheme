...
const tabs = [
  ...
  { id: "outercases", label: "Controller Outer Case", icon: "ph:plugs", color: "bg-gray-50 text-gray-600 border-gray-200" },
  { id: "appcontrollers", label: "App Controller", icon: "ph:device-mobile", color: "bg-lime-50 text-lime-600 border-lime-200" },
  { id: "powersupplies", label: "Power Supply", icon: "ph:lightning", color: "bg-amber-50 text-amber-600 border-amber-200" },
];
