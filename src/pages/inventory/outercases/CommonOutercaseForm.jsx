...
import { OUTER_CASE_TYPES } from "@/utils/constants";

const CommonOutercaseForm = ({ isEdit = false, initialData = {}, onSubmit, onCancel, title }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (onSubmit) {
        ...
        toast.success(`Outer Case ${isEdit ? "updated" : "added"} successfully!`);
        navigate("/inventory/outercases");
      }
    } catch (error) {
      toast.error(`Failed to ${isEdit ? "update" : "add"} outer case`);
      console.error(error);
    } finally {
...
export default CommonOutercaseForm;
